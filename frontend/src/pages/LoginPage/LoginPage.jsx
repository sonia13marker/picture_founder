  ...
  return (
    <div className={styles.singup}>
      <span className={styles.header}>
        {windowWidth <= 768 ? (
          <Logo newWidth="156" newHeight="59" />
        ) : (
          <Logo newWidth="220" newHeight="84" />
        )}

        <h2 className={styles.header__h2}>Вход в аккаунт</h2>
      </span>

      <form id="loginForm" className={styles.body} onSubmit={handleSubmit}>
        {/* email input */}
        ...
        <span className="input__wrapper2">
          ...
          <p className="input__error">{errorMessage || errorMessagePassword}</p>
        </span>

        <span className={styles.lineWrapper}>
          <span
            className={` ${styles.body__checkbox} ${styles.login__wrapper}`}
          >
            <input
              type="checkbox"
            ...
            <label
              ...
              className={` ${styles.body__checkbox__label} ${styles.login__wrapper__label}`}
            >
              Запомнить меня
            </label>
          </span>

          <Link to="/forgot_password" className={styles.lineWrapper__link}>
            Забыли пароль?
          </Link>
        </span>
        ...
        <span className={styles.button}>
          <button
            type="submit"
            className={styles.body__submitBtn}
          ...
          <span className={styles.button__container}>
            Ещё не авторизованы?{" "}
            <span
              className={` ${styles.lineWrapper__link} ${styles.boldLink}`}
